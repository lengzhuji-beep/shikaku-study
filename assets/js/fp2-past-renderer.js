    ...
    function showFp2ResultCard() {
      ...
      resCard.innerHTML = `
        ...
        <div style="display:flex; justify-content:center; gap:15px; flex-wrap:wrap;">
          <button type="button" id="retryFp2ExamBtn" class="btn" style="background:#345d4d; color:white; padding:12px 24px; font-weight:bold; border-radius:6px; border:none; cursor:pointer;">
