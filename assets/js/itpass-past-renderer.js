    ...
    card.innerHTML = `
      <div class="quiz-header-row">
        <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
          <span class="quiz-num-badge" style="font-size:0.95rem; padding:5px 12px; background:#ebf8ff; color:#2b6cb0;">第 ${qNum} 問 / 全 ${total} 問</span>
  ...
  function showExamResultCard() {
    ...
    resCard.innerHTML = `
      ...
      <div style="display:flex; justify-content:center; gap:15px; flex-wrap:wrap;">
        <button type="button" id="retryExamBtn" class="btn" style="background:#3182ce; color:white; padding:12px 24px; font-weight:bold; border-radius:6px; border:none; cursor:pointer;">
      ...
      card.innerHTML = `
        <div class="quiz-header-row">
          <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
            <span class="quiz-num-badge" style="background:#ebf8ff; color:#2b6cb0;">第 ${item.q_num || (index + 1)} 問</span>
    ...
    const answerTableRows = questions.map((q, idx) => {
      ...
      return `
        <tr>
          ...
          <td>${catName}</td>
          <td style="text-align:center; font-weight:bold; color:#2b6cb0; font-size:1.1rem; width:25%;">${q.answer}</td>
        </tr>
      `;
    }).join('');
