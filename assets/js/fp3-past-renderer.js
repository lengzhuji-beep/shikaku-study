/**
 * 資格対策ドットコム - FP3級過去問 過去5年分（全15回・900問）動的レンダリングスクリプト
 */
    ...
    function showFp3ResultCard() {
      ...
      resCard.innerHTML = `
        ...
        <div style="display:flex; justify-content:center; gap:15px; flex-wrap:wrap;">
          <button type="button" id="retryFp3ExamBtn" class="btn" style="background:#3182ce; color:white; padding:12px 24px; font-weight:bold; border-radius:6px; border:none; cursor:pointer;">
